...
class TestPipelineFlow:
    ...
    @patch("clinical_data_etl.orchestration.flows.dbt_seed_task")
    ...
    def test_full_pipeline_calls_all_tasks(
        ...
        mock_seed.return_value = "PASS"
        mock_snapshot.return_value = "PASS"
        mock_dbt_run.return_value = "PASS=11"
        mock_dbt_test.return_value = "PASS=64"
    ...
    def test_ingest_only_skips_dbt(
        ...
        mock_ingest.return_value = {"beneficiary": {"loaded": 100, "rejected": 0}}
        mock_validate.return_value = {"fct_claims": 500}
